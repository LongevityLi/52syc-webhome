...
INSERT INTO `lylme_config` VALUES ('title', '上网导航 - xx', '网站名称');
INSERT INTO `lylme_config` VALUES ('description', 'xx导航页致力于简洁高效无广告的上网导航和搜索入口，沉淀最具价值链接，全站无商业推广，简约而不简单。', '网站描述');
INSERT INTO `lylme_config` VALUES ('icp', '', '备案号');
INSERT INTO `lylme_config` VALUES ('home-title', '<h2 class="title">上网，从这里开始！</h2>', '首页标题');
INSERT INTO `lylme_config` VALUES ('copyright', 'Copyright ©2023 <a href=\"/\">LyLme Spage</a>.  All Rights Reserved.', '版权代码');
INSERT INTO `lylme_config` VALUES ('keywords', 'xx导航页,百度搜索,哔哩哔哩搜索,知乎搜索,导航,LyLme Spage,网站导航,上网导航', '关键字');
...
(18, '超值优惠券', 1, 'https://yhq.liuxingw.com/', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-qie00\"></use></svg>', NULL, 10),
...
(20, '流星社区', 1, 'https://bbs.liuxingw.com/', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-home00\"></use></svg>', NULL, 10),
...
(63, '流量消失器', 5, 'https://shua.leyunz.top/', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-linux\"></use></svg>', NULL, 10),
(64, 'IP查询', 5, 'https://api.leyunz.top/ip', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-csdn\"></use></svg>', NULL, 10),
...
(78, '官方主页', 7, 'https://liuxingw.com/', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-home00\"></use></svg>', NULL, 10),
(79, '申请收录', 7, '/apply', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-sq00\"></use></svg>', NULL, 10),
(80, '建议&反馈', 7, 'https://support.qq.com/products/', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#icon-fk00\"></use></svg>', NULL, 10);
...
(1, '主页', 'https://liuxingw.com/', 0),
(2, '社区', 'https://bbs.liuxingw.com/', 1),
(3, '小工具', 'https://shua.leyunz.top', 1),
(4, '关于本站', '/about', 1),
(5, '申请收录', '/apply', 1);
